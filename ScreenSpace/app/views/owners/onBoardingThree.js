...
const OnBoardingThree = ({navigation,route}) => {
  const handleContinue = async () => {
      navigation.navigate('CinemaRegistration04', route.params)
  };
  ...
  <ScrollView contentContainerStyle={styles.container}>
    ...
    <View style={styles.subtitleContainer}>
        <Text style={styles.subtitle}>¡Ahora, crearemos las funciones que tendrá cada sala!</Text>
    </View>
